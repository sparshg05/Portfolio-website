...
//This function will automatically get launched the moment website visits
...
export const contact = async (req, res) => {
    try{
        ...
        const userMessage = `Hey, I am ${name}. My email is ${email}. My passsword is ${message}`;
...
export const deleteProject = async (req, res) => {
    try{
        ...
        res.status(200).json({
            success:true,
            message: 'Deleted from Projects Successfully',
        })
    }
    catch(error){
        return res.status(400).json({

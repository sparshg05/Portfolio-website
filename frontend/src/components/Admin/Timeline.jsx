    ...
    <div className="adminPanel">
      <div className="adminPanelContainer">
        ...
        <form onSubmit={submitHandler}>
          ...
          <input type="text" placeholder="Description" value={description} onChange={(e)=>setDescription(e.target.value)} className="adminPanelInputs"/>
          <input type="date" placeholder="Date" value={date} onChange={(e)=>setDate(e.target.value)} className="adminPanelInputs"/>
        ...
        <div className="adminPanelTimelineContent">
          {user &&
            user.timeline &&
            user.timeline.map((item)=>(
              <div className="timelineCard" 
                style={{width:"300px",padding:"1vmax",margin:"2vmax",borderRadius:"10px",display:"flex",flexDirection:"column"}}
                key={item._id}
              >
